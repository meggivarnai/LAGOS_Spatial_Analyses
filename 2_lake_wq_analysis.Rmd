...
A: The more chlorophyll there is the more turbid the water is therefore we have less clarity the deeper the secchi disk goes.
...
```{r}
counts <- spatial_lakes %>%
  group_by(lagoslakeid) %>%
  summarise(count=n()) #mutate doesnt combine id
